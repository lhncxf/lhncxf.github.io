...
*   **原型、原型链与继承机制**
    ...
    *   📝 [JavaScript_TypeScript_核心闭环.md (内链)](./前端开发/语言内核与基建重塑/JavaScript_TypeScript_核心闭环_从原型链_闭包陷阱到高阶类型体操的体系化梳理.md)
*   **闭包 (Closures) 与内存泄露**
...
*   **事件循环 (Event Loop) 与宏任务/微任务**
    ...
    *   📝 [高并发-高频交互下的事件循环.md (内链)](./前端开发/语言底座与高阶特性/高并发-高频交互下的事件循环_(Event_Loop)_调度与_Web_Worker_离线计算优化.md)
*   **V8 垃圾回收 (GC) 机制 (Scavenge/Mark-Sweep)**
    *   🔗 [V8 Blog: Trash talk (外链)](https://v8.dev/blog/trash-talk)
    *   📝 [V8_引擎垃圾回收机制与前端内存泄漏.md (内链)](./前端开发/语言底座与高阶特性/V8_引擎垃圾回收机制与前端内存泄漏全链路监控体系方案.md)
*   **Promise (A+ 规范) 与 Async/Await**
    *   🔗 [Promises/A+ Spec (外链)](https://promisesaplus.com/)
    *   📝 [Promise_A+规范与微任务调度的底层实现解构.md (内链)](./前端开发/语言底座与高阶特性/Promise_A+规范与微任务调度的底层实现解构.md)
*   **ES6+ 高阶：Generator/Proxy/Reflect**
    ...
    *   📝 [ES6_核心机制与进阶应用.md (内链)](./前端开发/语言底座与高阶特性/ES6_核心机制与进阶应用.md)
...
*   **高级类型体操 (Conditional/Mapped/Infer)**
    ...
    *   📝 [TypeScript_高级类型体操与工程实践.md (内链)](./前端开发/语言底座与高阶特性/TypeScript_高级类型体操与工程实践.md)
...
*   **语义化、A11y (无障碍) 与 SEO**
    ...
    *   📝 [HTML_渲染核心与语义化重塑.md (内链)](./前端开发/语言内核与基建重塑/HTML_渲染核心与语义化重塑.md)
...
*   **渲染流水线：重排 (Reflow) 与重绘 (Repaint) 优化**
    ...
    *   📝 [CSS_渲染机制与架构演进.md (内链)](./前端开发/语言内核与基建重塑/CSS_渲染机制与架构演进.md)
...
*   **响应式原理：DefineProperty vs Proxy**
    ...
    *   📝 [Vue3_响应式内核与编译时演进.md (内链)](./前端开发/框架内核与生态/Vue3_响应式内核与编译时演进.md)
*   **虚拟 DOM 与 Diff 算法 (双端比较 vs 快速 Diff)**
    ...
    *   📝 [Vue2与3及React响应式与渲染机制源码级横评.md (内链)](./前端开发/框架内核与生态/Vue2与3及React响应式与渲染机制源码级深度横评.md)
...
*   **状态管理：Vuex vs Pinia (竞态与持久化)**
    ...
    *   📝 [万行级项目中状态管理的竞态控制.md (内链)](./前端开发/框架内核与生态/万行级项目中状态管理_(Pinia-Redux)_的竞态控制与读写性能瓶颈突破.md)
...
*   **Hooks 架构：useState/useEffect 闭包陷阱**
    ...
    *   📝 [React_Hooks架构与闭包陷阱.md (内链)](./前端开发/框架内核与生态/React_Hooks架构与闭包陷阱.md)
*   **Fiber 调度架构：Lane 模型与时间分片**
    ...
    *   📝 [React_Fiber与Concurrent并发架构源码级调度解析.md (内链)](./前端开发/框架内核与生态/React_Fiber与Concurrent并发架构源码级调度解析.md)
...
*   **SSR/SSG：Next.js 与 React Server Components (RSC)**
    ...
    *   📝 [SSR_服务端渲染的_Node.js_内存泄露排查.md (内链)](./前端开发/框架内核与生态/SSR_(Nuxt-Next)_服务端渲染的_Node.js_内存泄露排查与首屏_TTFB_极限优化.md)
...
*   **Viewport 视口、Rem/Vw 适配方案**
    ...
    *   📝 [跨端与多端架构体系志_响应式H5.md (内链)](./前端开发/语言内核与基建重塑/跨端与多端架构体系志_响应式H5_微信小程序底层_RN与uni-app跨端方案的生命周期与性能天花板对比.md)
...
*   **双线程架构：Logic Layer vs View Layer**
    ...
    *   📝 [微信小程序底层渲染机制：setData阻塞治理.md (内链)](./前端开发/跨端与多端底层架构/微信小程序底层渲染机制：双线程通信带来的_setData_阻塞问题与终极解决思路.md)
*   **setData 原理与渲染性能极限调优**
...
*   **RN 架构：JSI/Fabric 渲染引擎演进**
    ...
    *   📝 [UniApp与ReactNative架构对比.md (内链)](./前端开发/跨端与多端底层架构/UniApp与ReactNative架构对比与技术选型防坑指南.md)
...
*   **Electron 进程间通信 (IPC) 与主/渲染进程架构**
    ...
    *   📝 [PWA_-_Electron_进程间通信耗时优化.md (内链)](./前端开发/跨端与多端底层架构/PWA_-_Electron_桌面级前端应用的探索与进程间_(IPC)_通信耗时优化.md)
...
*   **Webpack：Loader/Plugin 机制与 HMR 原理**
    ...
    *   📝 [现代前端构建体系原理与调优.md (内链)](./前端开发/前端工程化与组件化/现代前端构建体系原理与调优：Webpack到Vite的平滑过渡.md)
...
*   **Rust 赋能：SWC 与 Rspack 高性能构建**
    ...
    *   📝 [Rust_工具链生态对前端工程化构建的打击.md (内链)](./AI与前沿探索/前端计算极限探索/Rust_工具链生态_(SWC_-_Rspack)_对前端工程化构建降维打击的持续追踪.md)

### 4.2 工程规范与包管理
*   **Monorepo 架构：pnpm workspace 与 Turborepo**
    *   🔗 [pnpm Docs: Workspaces (外链)](https://pnpm.io/workspaces)
    *   📝 [定制化_UI_组件库基于_Monorepo_的包管理.md (内链)](./前端开发/前端工程化与组件化/定制化_UI_组件库的从_0_到_1：基于_Monorepo_的包管理与自动化按需加载设计.md)
*   **代码质量控制：ESLint/Prettier/Husky 自动化链路**
    *   🔗 [Husky Docs (外链)](https://typicode.github.io/husky/)
    *   📝 [万行级代码防腐化：基于_ESLint-Husky-Prettier.md (内链)](./前端开发/前端工程化与组件化/万行级代码防腐化：基于_ESLint-Husky-Prettier_的深度定制化拦截与_CI-CD....md)

### 4.3 架构高级模式
*   **微前端：Qiankun 沙箱隔离与 Single-spa**
    *   🔗 [Qiankun Docs (外链)](https://qiankun.umijs.org/)
    *   📝 [微前端(qiankun&wujie)架构拆分实战.md (内链)](./系统架构与设计模式/分布式与微前端深度治理/微前端(qiankun&wujie)架构拆分实战与技术债治理.md)
*   **低代码 (Low-Code)：JSON Schema 协议与物料系统**
    *   🔗 [JSON Schema Spec (外链)](https://json-schema.org/)
    *   📝 [低代码平台：JSON_Schema_渲染引擎架构.md (内链)](./系统架构与设计模式/复杂业务系统全链路设计/低代码_(Low-Code)_平台：JSON_Schema_渲染引擎与组件物料协议架构设计.md)
...
*   **Event Loop、Libuv 线程池与 I/O 模型**
    ...
    *   📝 [NodeJS_事件驱动机制与架构演进.md (内链)](./后端开发与中间件/服务端语言与框架/NodeJS_事件驱动机制与架构演进.md)
*   **Buffer、Stream 与文件处理**
...
*   **Nest.js：IoC 控制反转、DI 注入与 AOP 切面**
    ...
    *   📝 [Nest.js_-_Express.js_架构设计.md (内链)](./后端开发与中间件/服务端语言与框架/Nest.js_-_Express.js_架构设计：中间件洋葱模型与企业级异常拦截链路.md)
*   **BFF 层：数据裁剪、聚合与 GraphQL**
    *   🔗 [GraphQL Docs (外链)](https://graphql.org/)
    *   📝 [BFF层(Node.js)架构设计与业务聚合实战.md (内链)](./后端开发与中间件/服务端语言与框架/BFF层(Node.js)架构设计与业务聚合实战.md)
...
*   **MySQL：索引优化 (B+ Tree)、事务隔离级别 (MVCC)**
    ...
    *   📝 [复杂业务的事务隔离级别场景分析.md (内链)](./后端开发与中间件/关系型数据库进阶/复杂业务的事务隔离级别：幻读-脏读场景分析与乐观锁-悲观锁在订单状态防刷中的应用.md)
*   **Redis：数据结构与缓存三剑客 (击穿/穿透/雪崩)**
    *   🔗 [Redis Docs (外链)](https://redis.io/docs/)
    *   📝 [缓存击穿、穿透与雪崩的防御与兜底.md (内链)](./后端开发与中间件/缓存架构与海量数据/缓存击穿、缓存穿透与缓存雪崩的系统级防御与兜底预案.md)
*   **消息队列 (MQ)：RabbitMQ/Kafka 异步削峰与消息幂等性**
    *   🔗 [RabbitMQ Docs (外链)](https://www.rabbitmq.com/getstarted.html)
    *   📝 [消息防丢失设计与幂等性消费一致性保障.md (内链)](./后端开发与中间件/消息队列架构实战/消息防丢失设计、幂等性消费在前端状态回流中的一致性保障.md)
...
*   **WebSocket 与 WebRTC 低延迟通信**
    ...
    *   📝 [WebRTC与WebSocket在低延迟通信中的架构.md (内链)](./运维部署与云原生/网络通信与跨域隔离/WebRTC与WebSocket在低延迟音视频通信中的架构演进.md)
*   **前端安全防护：XSS、CSRF、CSP 与 JWT 鉴权**
    *   🔗 [OWASP Top Ten (外链)](https://owasp.org/www-project-top-ten/)
    *   📝 [前端防高维攻击与CSP策略.md (内链)](./前端开发/性能优化与安全/前端防高维攻击：基于_BFF_层的反_XSS-CSRF_终极方案与_CSP_内容安全策略.md)

### 6.2 Nginx 与服务器运维
*   **Nginx：反向代理、负载均衡与 Gzip 调优**
    *   🔗 [Nginx Docs: Beginner's Guide (外链)](https://nginx.org/en/docs/beginners_guide.html)
    *   📝 [前端视角的Nginx高阶配置.md (内链)](./运维部署与云原生/服务器运维监控预警/前端视角的Nginx高阶配置与线上异常监控(Sentry)闭环.md)
*   **Linux 系统：文件系统、进程管理与并发压测**
    *   🔗 [Linux Journey (外链)](https://linuxjourney.com/)
    *   📝 [服务器并发资源压测与Node.js进程级监控.md (内链)](./运维部署与云原生/服务器运维监控预警/服务器并发资源压测_(JMeter)_与_Node.js_进程级性能监控预警闭环.md)

### 6.3 容器化与 CI/CD
*   **Docker：镜像瘦身、多阶段构建 (Multi-stage)**
    *   🔗 [Docker Docs: Multi-stage builds (外链)](https://docs.docker.com/build/building/multi-stage/)
    *   📝 [前端_Docker_镜像极致瘦身与多阶段构建.md (内链)](./运维部署与云原生/容器化高阶部署/前端_Docker_镜像极致瘦身与多阶段构建_(Multi-stage_build)_实战.md)
*   **Kubernetes (K8s)：Pods、Service 与回滚策略**
    *   🔗 [K8s Docs: Concepts (外链)](https://kubernetes.io/docs/concepts/)
    *   📝 [K8s_基础拓扑与前端高可用部署回滚策略.md (内链)](./运维部署与云原生/容器化高阶部署/K8s_(Kubernetes)_基础拓扑认知：Pods、节点调度、前端容器化部署的高可用回滚策略.md)
*   **CI/CD：GitHub Actions 与 GitLab CI 流水线定制**
    *   🔗 [GitHub Actions Docs (外链)](https://docs.github.com/en/actions)
    *   📝 [GitOps与企业级CI-CD流水线定制.md (内链)](./运维部署与云原生/自动化流水线演练/GitOps与企业级CI-CD流水线的深度定制化实战.md)
